    ...
    <div class="row" style="margin-top:10px;">
      <div class="large-12">
        <?php
          ...
          if(isset($_SESSION['cart'])) {
            ...
            if($result){
              ...
              while($obj = $result->fetch_object()) {
                $cost = $obj->price * $quantity; //work out the individual costs
          ...
          echo '<tr>';
          echo '<td colspan="3" align="right"><u><h5>Total</h5></u></td>';
          echo '<td><strong><h5>'.$total.'</h5></strong></td>';
          echo '</tr>';
          ...
          echo '<strong>You have no items in your shopping cart.</strong>';
        }
